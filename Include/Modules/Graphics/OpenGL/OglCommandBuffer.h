...
public:
    ...
    virtual void DrawMesh(glm::mat4 &matrix, unsigned int &meshAssetId, unsigned int &shaderId);
    virtual void DrawMesh(glm::mat4 &matrix, glm::mat4 &matrixInv, unsigned int &meshAssetId, unsigned int &shaderId);

    virtual void Execute();

    virtual void SetMatrix(const std::string &name, unsigned int shaderId, glm::mat4 matrix);
    virtual void SetFloat(const std::string &name, unsigned int shaderId, float value);
    virtual void SetVector(const std::string &name, unsigned int shaderId, glm::vec4 &vector);

    virtual void SetTexture(const std::string &name, unsigned int shaderId, unsigned int textureId);
...
private:
    ...
    virtual void SetMatrixOgl(const std::string &name, int programId, glm::mat4 matrix);
    virtual void SetFloatOgl(const std::string &name, int programId, float value);
    virtual void SetVectorOgl(const std::string &name, int programId, glm::vec4 &vector);
