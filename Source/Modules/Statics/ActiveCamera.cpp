...
REGISTER_SERIALIZED_CLASS(ActiveCamera)
CameraComponent *ActiveCamera::GetCameraComponent() { return Camera; }

TransformComponent *ActiveCamera::GetTransformComponent() { return Transform; }

glm::mat4 ActiveCamera::ProjectionMatrix() { return Camera->ProjectionMatrix; }

glm::mat4 ActiveCamera::ViewMatrix() { return Camera->ViewMatrix; }
...
ActiveCamera::ActiveCamera() {
  ...
  Transform = componentManager->GetComponentOfType<TransformComponent>(
      Camera->EntityId());
}
