...
Solver::Solver() { solver = new Solver_Impl(); }
...
void Solver::InitializeSystems() { solver->InitializeSystems(); }

bool Solver::Simulate() { return solver->Simulate(); }

bool Solver::IsValid() { return solver->IsValid(); }
